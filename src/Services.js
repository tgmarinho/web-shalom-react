                            ...
                            <div className="row">
                                <div className="col-md-3 col-sm-6">
                                    <div className="service-item">
                                        ...
                                        <a href="%PUBLIC_URL%/ministerio/palavra/equipe.html" className="btn btn-light">Equipe</a>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6">
                                    <div className="service-item">
                                        ...
                                        <p>Carla Suzana</p>
                                        <a href="%PUBLIC_URL%/ministerio/louvor/equipe.html" className="btn btn-light">Equipe</a>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6">
                                    <div className="service-item">
                                        ...
                                        <p>Hanay</p>
                                        <a href="%PUBLIC_URL%/ministerio/infantil/equipe.html" className="btn btn-light">Equipe</a>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6">
                                    <div className="service-item">
                                        ...
                                        <p>Silvana</p>
                                        <a href="#" className="btn btn-light">Equipe</a>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6">
                                    <div className="service-item">
                                ...
                                <div className="col-md-3 col-sm-6">
                                    <div className="service-item">
                                        ...
                                        <a href="%PUBLIC_URL%/ministerio/lirio-dos-vales/equipe.html" className="btn btn-light">Leia mais</a>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6">
                                    <div className="service-item">
                                        ...
                                        <p>Jovens</p>
                                        <a href="%PUBLIC_URL%/ministerio/meetup/equipe.html" className="btn btn-light">Leia mais</a>
                                    </div>
                                </div>
                            </div>
                            {/* /.row (nested) */}
