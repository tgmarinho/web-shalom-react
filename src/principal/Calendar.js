...
const Calendar = () => {
    ...
    return (
        ...
        <div id="agenda" className="map">
            ...
            <iframe width="100%" height="100%" frameBorder={0} scrolling="no" marginHeight={0} marginWidth={0} style={{ borderWidth: 0 }} src="https://calendar.google.com/calendar/embed?showTitle=0&showPrint=0&showCalendars=0&showTz=0&mode=AGENDA&height=600&wkst=1&bgcolor=%23FFFFFF&src=avivamentoshalom%40gmail.com&color=%2329527A&ctz=America%2FCampo_Grande" />
            <br />
            <br />
            <br />
